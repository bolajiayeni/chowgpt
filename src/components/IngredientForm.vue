<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="flex flex-wrap -mx-2 mb-4">
      <div class="w-full px-2">
        <input type="checkbox" id="onlyTheseIngredients" v-model="onlyTheseIngredients" />
        <label class="ml-2 text-warm-gray-700" for="onlyTheseIngredients">I have only these ingredients</label>
      </div>
    </div>
    <button class="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded">Search</button>
  </form>
</template>
